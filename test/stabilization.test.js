...
test('classroom package includes LAN diagnostics helpers and readable README text', () => {
  ...
  assert.match(packageScript, /pilot-evidence-template\.json/);
  assert.match(packageScript, /pilot:create/);
  ...
  assert.match(packageScript, /псевдоним S1/);
  assert.doesNotMatch(packageScript, /имя ученика/i);
